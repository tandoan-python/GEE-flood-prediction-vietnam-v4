...
with col2:
    ...
    if st.session_state.error_message:
        ...
        <div style="
            ...
            border-radius: 10px; 
            /* *** SUA LOI: Doi overflow: hidden -> visible *** */
            overflow: visible; 
            border: 1px solid #ccc;
            position: relative; /* Them vao de giu text ben trong */
            height: 40px; /* Dat chieu cao co dinh */
        ">
            <div style="
                width: {prob_percent}%; 
            ...
            <div style="
                position: absolute; /* Dat text len tren thanh */
                top: 0;
                left: 10px; /* Canh le text */
                height: 100%;
                display: flex;
                align-items: center;
                font-weight: bold;
                color: #333; /* Mau text de doc */
                text-shadow: 0 0 2px white; /* Bong chu cho de doc */
            ">
        ...
        st.subheader("Dự báo Mưa 14 Ngày (GFS)")
        if st.session_state.forecast_data:
            try:
                ...
                # Nhom theo ngay
                df_daily = df_forecast.set_index('time').resample('D').sum().reset_index()
